...
1.Maven 3 (https://www.sonatype.com/books/mvnref-book/reference/installation.html)
2.Git command line tool (https://help.github.com/articles/set-up-git)
3.Eclipse with the m2e plugin (m2e is installed by default when using the STS 
